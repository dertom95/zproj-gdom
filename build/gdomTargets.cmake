...
foreach(_expectedTarget gdom gdom-static)
...
# Create imported target gdom
add_library(gdom SHARED IMPORTED)

set_target_properties(gdom PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/ttrocha/_dev/extprojects/incubation/zmq/globdom/include"
  INTERFACE_LINK_LIBRARIES "/usr/lib/libzmq.so;/usr/local/lib/libczmq.so"
)

# Create imported target gdom-static
add_library(gdom-static STATIC IMPORTED)

set_target_properties(gdom-static PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GDOM_STATIC"
  INTERFACE_INCLUDE_DIRECTORIES "/home/ttrocha/_dev/extprojects/incubation/zmq/globdom/include"
  INTERFACE_LINK_LIBRARIES "/usr/lib/libzmq.so;/usr/local/lib/libczmq.so"
)
...
set_target_properties(gdom-static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/home/ttrocha/_dev/extprojects/incubation/zmq/globdom/build/libgdom.a"
  )
